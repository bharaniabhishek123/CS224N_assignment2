...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        ### YOUR CODE HERE
        cn = Config()
        self.input_placeholder= tf.placeholder(tf.float32,shape=(cn.batch_size,cn.n_features))
        self.labels_placeholder = tf.placeholder(tf.int32,shape=(cn.batch_size,cn.n_classes))
    ...
    def add_training_op(self, loss):
        ...
        train_op= tf.train.GradientDescentOptimizer(learning_rate=1e-4,).minimize(loss)
